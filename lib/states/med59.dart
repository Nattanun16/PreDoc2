...
class Med59 extends StatefulWidget {
  const Med59({Key? key}) : super(key: key);

  @override
  _Med59State createState() => _Med59State();
}

class _Med59State extends State<Med59> {
  var medNode = med59;
  @override
