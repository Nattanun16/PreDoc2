...
class Med18b extends StatefulWidget {
  const Med18b({Key? key}) : super(key: key);

  @override
  _Med18bState createState() => _Med18bState();
}

class _Med18bState extends State<Med18b> {
  var medNode = med18b;
  @override
