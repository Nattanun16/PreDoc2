...
class Med10a extends StatefulWidget {
  const Med10a({Key? key}) : super(key: key);

  @override
  _Med10aState createState() => _Med10aState();
}

class _Med10aState extends State<Med10a> {
  var medNode = med10a;
  @override
