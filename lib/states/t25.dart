...
class T25 extends StatefulWidget {
  const T25({Key? key}) : super(key: key);

  @override
  _T25State createState() => _T25State();
}

class _T25State extends State<T25> {
  var medNode = t25;
  @override
