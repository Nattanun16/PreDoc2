...
class Med21 extends StatefulWidget {
  const Med21({Key? key}) : super(key: key);

  @override
  _Med21State createState() => _Med21State();
}

class _Med21State extends State<Med21> {
  var medNode = med21;
  @override
